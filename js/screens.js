...
export function screenShare() {
  ...
  return `
    ...
    <div class="code-display surface">
      ...
      <button class="btn btn-primary" data-action="copyCode">Copy code</button>
    </div>

    <div style="height:16px"></div>
    <a class="btn btn-ghost" href="open.html" target="_blank" rel="noopener">
      Open card page ↗
    </a>
    <p class="link-note">Share this link with them so they can enter the code.</p>
